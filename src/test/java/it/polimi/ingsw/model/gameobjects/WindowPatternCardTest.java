...
public class WindowPatternCardTest {
    ...
    public void existsAdjacentDice(){
        ...
        Assert.assertEquals(false, schemeCard.existsAdjacentDice(1,1));
        Dice d = new Dice(Colors.BLUE);
        d.setValue(1);
        schemeCard.putDice(d, 0, 0);
        Assert.assertEquals(true, schemeCard.existsAdjacentDice(1,1));
        Dice d1 = schemeCard.getDice(1,0);
        Dice d2 = schemeCard.getDice(0,1);
        Dice d3 = schemeCard.getDice(1,1);
        Dice[] adjacentDices = {d1, d2, d3};
        Assert.assertEquals(false, schemeCard.existsAdjacentDice(adjacentDices));
        d2 = new Dice(Colors.BLUE);
        d2.setValue(3);
        schemeCard.putDice(d2, 1, 1);
        adjacentDices[1] = d2;
        Assert.assertEquals(true, schemeCard.existsAdjacentDice(adjacentDices));
    }
    ...
    public void checkPos(){
        ...
        d1.setValue(1);
        Assert.assertEquals(false, schemeCard.putDice(d1,1,1));
        Assert.assertEquals(true, schemeCard.putDice(d1, 0, 0));
        Dice d2 = new Dice(Colors.YELLOW);
        d2.setValue(2);
        Assert.assertEquals(false, schemeCard.checkPos(d2, 0,1));
        Dice d3 = new Dice(Colors.BLUE);
        d3.setValue(1);
        Assert.assertEquals(false, schemeCard.checkPos(d3, 0,1));
        d3.setValue(4);
        Assert.assertEquals(true, schemeCard.checkPos(d3, 0,1));
    }
    ...
    public void putDice(){
        ...
        Dice d = new Dice(Colors.BLUE);
        d.setValue(3);
        Assert.assertEquals(false, schemeCard.putDice(d, 0, 0));
        d.setValue(1);
        Assert.assertEquals(true, schemeCard.putDice(d, 0,0));
    ...
    public void putFirstDice(){
        ...
        Dice d = new Dice(Colors.BLUE);
        d.setValue(1);
        Assert.assertEquals(false, schemeCard.putFirstDice(d, 1, 1));
        Assert.assertEquals(true, schemeCard.putFirstDice(d, 1, 0));
    ...
    public void removeDice(){
        ...
        Assert.assertEquals(null, schemeCard.getDice(0,3));
    }
