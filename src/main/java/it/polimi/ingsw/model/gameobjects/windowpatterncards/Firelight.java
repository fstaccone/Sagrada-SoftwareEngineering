...
public class Firelight extends WindowPatternCard {
    ...
    public Firelight() {
        ...
        this.getWindow()[0][0].setValueConstraint(3);
        ...
        this.getWindow()[2][4].setColorConstraint(Colors.RED);
        this.getWindow()[3][0].setValueConstraint(5);
        this.getWindow()[3][2].setColorConstraint(Colors.YELLOW);
        this.getWindow()[3][3].setColorConstraint(Colors.RED);
        this.getWindow()[3][4].setValueConstraint(6);
